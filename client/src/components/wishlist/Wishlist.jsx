  ...
  return (
    <>
      <div className="w-[1200px] mx-auto">
        <div className="mt-16">
          <span className="mr-2 text-[16px] text-[#6B7280] font-medium">Home</span>
          <span className="mr-2 text-[16px] text-[#6B7280] font-medium">/</span>
          <span className=" text-[16px] text-[#DB4444] font-medium">Wishlist</span>
        </div>
      </div>
